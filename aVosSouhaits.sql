...
('Led Zibeline','argent',3,20,'/assets/images/led.jpg','/assets/images/silverlamp1.jpg',3,'Led saura révéler la rockstar qui sommeille en vous et vous métamorphosera en un véritable guitar hero.'),
('Olly Wayzontime','bronze',5,5,'/assets/images/olly.jpg','/assets/images/bronzelamp.jpg',6,'Dans la catégorie business, vous demandez notre spécialiste de la ponctualité: pannes de réveil, retards à répétition, terminé tout ça, soyez ponctuel comme un coucou suisse!'),
